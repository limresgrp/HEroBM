...
def analyze_distances(pdb_file, output_csv_file):
...
def main():
    ...
    parser.add_argument("-i", "--input", required=True, help="Input PDB/GRO file")
    parser.add_argument("-o", "--output", default="out.csv", help="Output CSV file (default: out.csv)")
    args = parser.parse_args()
    analyze_distances(args.input, args.output)
